...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <section class="container-fluid d-flex justify-content-center align-items-center vh-100 px-5 py-5 bg-white row" id="login">
        <section id="section-form">
            <h3 id="title-pass-rec">Mudança de senha</h3>
            <p id="sub-title-pass-rec">Coloque o <b>código</b> enviado em seu email no campo abaixo para prosseguir.</p>
            <form action="" class="">
                <div class="mb-3">
                    <input type="text" class="form-control" placeholder="Código" id="input-email">
                </div>
                <hr>
                <div class="row">
                        <div class="col">
